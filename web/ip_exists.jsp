...
<div>
	...
	<img src="logo.gif" class="logo">
		<br/>	
		<br/>	
		<h2 class="text-danger">十分钟内您只能注册一个新账号<br/>
			遇到问题，需要额外注册新账号请联系QQ：1811117272
		</h2>
			<br/>
		<br/>
		<br/>	
		<h6 class="text-danger">本游戏仅在非中国地区运营，请遵守本地法律使用本游戏服务<br/></h6>
		<h6 class="text-danger">版权所有 2023  天下团队 地点日本美国<br/></h6>
		<h4 class="copyright">© 2023 《天下AI网游》<br/><br/><a href="http://www.wapmud.com">游戏首页</a></h4>
